...
class UnRealEngine(GameEngine):
    def __init__(self, address, port, uiauto_interface):
        super(UnRealEngine, self).__init__(address, port,uiauto_interface)
    ...
    def get_element_text(self, element):
        """
            获取UMG文字内容，目前支持UMultiLineEditableText、UTextBlock、UMultiLineEditableTextBox及其子类UMG类型
        :param element: 查找到的Element
